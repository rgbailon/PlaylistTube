...
function CastModal({ isOpen, onClose, onConnect, currentVideo }) {
  ...
  const openReceiverInstructions = () => {
    setMode('receiver');
  };
        ...
        {currentVideo?.id && (
          <div className="mb-4 p-3 bg-blue-600/20 rounded-lg border border-blue-500/30">
            <p className="text-sm text-blue-400">
              ...
              {currentVideo.title?.substring(0, 50)}...
            </p>
          </div>
        )}
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="text-left">
                <div className="font-medium text-[var(--text-main)]">Open YouTube (Easiest)</div>
                <div className="text-xs text-[var(--text-muted)]">Opens video on this device</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-[(--text-muted)]">Open YouTube on projector browser</div>
              </div>
            </button>
        ...
        {mode === 'projector' && (
          <div>
            <button
              ...
              className="text-sm text-[var(--text-muted)] hover:text-[var(--text-main)] mb-3"
            >
            ...
            <div className="bg-[var(--bg-hover)] rounded-lg p-4 mb-4">
              ...
              <ol className="text-sm text-[var(--text-muted)] space-y-2">
                <li className="flex gap-2">
                  ...
                  <span>Make sure projector is on same WiFi as laptop</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-green-500">2.</span>
                  <span>Open browser on projector</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-green-500">3.</span>
                  <span>Go to: <span className="text-blue-400">youtube.com</span></span>
                </li>
                <li className="flex gap-2">
                  <span className="text-green-500">4.</span>
                  <span>Play the same video here</span>
                </li>
              </ol>
            </div>
            ...
            >
              ...
              Open YouTube on This Device
            </button>

            <p className="text-xs text-gray-500 mt-3 text-center">
              Tip: Play video on both devices and sync manually
            </p>
          </div>
        )}
