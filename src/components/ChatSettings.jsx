...
<div>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs" style={{ color: 'var(--text-main)' }}>{availableModels.find(m => m.value === model)?.name || 'Select a model'}</span>
          </div>
          <select
            value={model}
...
<div className="flex gap-2">
          <button
            onClick={saveConfig}
            disabled={validating}
            className="flex-1 px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-xs font-medium transition disabled:opacity-50"
          >
          ...
          <button
            onClick={validateApi}
            disabled={validating}
            className="px-3 py-2 border border-purple-200 text-purple-500 rounded-lg text-xs hover:bg-purple-50 transition disabled:opacity-50"
          >
